#!/bin/sh
# Asset layout script for OpenBSD console.
# http://millikeys.sourceforge.net/asset/
# https://github.com/deekayen/asset
...
wsconsctl keyboard.encoding=us  \
    ...
    keyboard.map+="keycode  18 =              j             J       asciitilde        asciitilde " \
    keyboard.map+="keycode  19 =              f             F           atilde            Atilde " \
    keyboard.map+="keycode  20 =              g             G       asciitilde        asciitilde " \
    keyboard.map+="keycode  21 =              y             Y       udiaeresis        Udiaeresis " \
    keyboard.map+="keycode  22 =              p             P           oslash          Ooblique " \
    ...
    keyboard.map+="keycode  32 =              e             E           eacute            Eacute " \
